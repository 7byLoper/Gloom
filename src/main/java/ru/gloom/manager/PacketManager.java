...
public class PacketManager {
    ...
    public void register() {
        ...
        events.registerListeners(checkManagerListener, combatListener, packetPlayerJoinQuit, hologramListener);
    }

    public void unregister() {
        EventManager events = PacketEvents.getAPI().getEventManager();
        events.unregisterListeners(checkManagerListener, combatListener, packetPlayerJoinQuit, hologramListener);
    }
